...
Set-ItemProperty -Path $windowsUpdateKey -Name "TargetReleaseVersionInfo" -Value "1809" -Type String -Force
Set-ItemProperty -Path $windowsUpdateKey -Name "ProductVersion" -Value "Windows 10" -Type String -Force
