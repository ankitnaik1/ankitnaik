...
Invoke-WebRequest -Uri "https://ardownload2.adobe.com/pub/adobe/reader/win/AcrobatDC/2400220687/AcroRdrDCx642400220687_en_US.exe" -OutFile "$env:TEMP\AcroRdrDCx64_en_US.exe"
